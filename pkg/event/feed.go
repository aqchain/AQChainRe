...
var errBadChannel = errors.New("event: Subscribe argument does not have sendable channel types")

// Feed implements one-to-many subscriptions where the carrier of events is a channel.
// Values sent to a Feed are delivered to all subscribed channels simultaneously.
//
// Feeds can only be used with a single types. The types is determined by the first Send or
// Subscribe operation. Subsequent calls to these methods panic if the types does not
// match.
//
...
func (e feedTypeError) Error() string {
	return "event: wrong types in " + e.op + " got " + e.got.String() + ", want " + e.want.String()
}
...
// until the subscription is canceled. All channels added must have the same element types.
//

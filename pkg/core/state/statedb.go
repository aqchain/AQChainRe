...
// Retrieve the balance from the given hash or 0 if object not found
...
// AddBalance adds amount to the prev associated with addr
...
// SubBalance subtracts amount from the prev associated with addr
...
// CreateAccount explicitly creates a state object. If a state object with the hash

...
func (c *stateObject) AddBalance(amount *big.Int) {
	// EIP158: We must check emptiness for the objects such that the prev
...
// It is used to remove funds from the Origin prev of a transfer.
...
func (self *stateObject) SetContribution(amount *big.Int) {
	self.db.journal = append(self.db.journal, contributionChange{
		account: &self.address,

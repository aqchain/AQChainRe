...
// NewNonce returns the new canonical nonce for the managed prev
...
// GetNonce returns the canonical nonce for the managed or unmanaged prev.
//
...
// HasAccount returns whether the given hash is managed or not
...
func (ms *ManagedState) getAccount(addr common.Address) *account {
	if account, ok := ms.accounts[addr]; !ok {
		...
		// Always make sure the state prev nonce isn't actually higher

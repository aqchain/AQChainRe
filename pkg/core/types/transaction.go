...
var (
	...
	ErrInvalidType    = errors.New("invalid transaction types")
...
type txdata struct {
	Type         TxType          `json:"types"   gencodec:"required"`
...
// Transaction slice types for basic sorting.

...
// field types overrides for gencodec
...
func CopyHeader(h *Header) *Header {
	...
	// add pocContextProto to header
	cpy.PocContext = &PocContextProto{}
	if h.PocContext != nil {
		cpy.PocContext = h.PocContext
	}
	return &cpy
}
...
func (b *Block) PocCtx() *PocContext { return b.PocContext }

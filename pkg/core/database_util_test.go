...
func TestHeaderStorage(t *testing.T) {
	...
	header := &types.Header{Number: big.NewInt(42), Extra: []byte("test header"), PocContext: pocContext.ToProto()}
...
func TestBodyStorage(t *testing.T) {
	...
	pocContext, _ := types.NewPocContext(db)
	body := &types.Body{Uncles: []*types.Header{{Extra: []byte("test header"), PocContext: pocContext.ToProto()}}}

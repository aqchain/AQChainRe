...
func SetupGenesisBlock(db ethdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	if genesis != nil && genesis.Config == nil {
		return params.PocChainConfig, common.Hash{}, errGenesisNoConfig
	}
...
func (g *Genesis) ToBlock() (*types.Block, *state.StateDB, *state.StateDBRecord) {
	...
	pocContextProto := pocContext.ToProto()
	head := &types.Header{
...
func decodePrealloc(data string) GenesisAlloc {
	...
	for _, account := range p {
		...
		fmt.Println(common.BigToAddress(account.Addr).String())
	}
	return ga
}

func initGenesisPocContext(g *Genesis, db ethdb.Database) *types.PocContext {
	dc, err := types.NewPocContextFromProto(db, &types.PocContextProto{})
	if err != nil {
		return nil
	}
	if g.Config != nil && g.Config.Poc != nil && g.Config.Poc.Validators != nil {
		dc.SetValidators(g.Config.Poc.Validators)
		for _, validator := range g.Config.Poc.Validators {

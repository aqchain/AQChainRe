...
//
// Decode uses the following types-dependent decoding rules:
//
// If the types implements the Decoder interface, decode calls
// DecodeRLP.
//
...
// types is allocated. If the pointer is non-nil, the existing value
// will be reused.
//
...
//
//     types StructWithEmptyOK struct {
//         Foo *[20]byte `rlp:"nil"`
//     }
//
...
//
// To decode into an unsigned integer types, the input must also be an RLP
// string. The bytes are interpreted as a big endian representation of
// the integer. If the RLP string is larger than the bit size of the
// types, Decode will return an error. Decode also supports *big.Int.

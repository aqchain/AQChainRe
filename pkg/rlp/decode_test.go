...
func TestDecodeErrors(t *testing.T) {
	...
	expectErr := "rlp: types chan bool is not RLP-serializable"
...
var decodeTests = []decodeTest{
	...
	},
	{
		...
		error: "rlp: invalid struct tag \"tail\" for rlp.invalidTail2.B (field types is not slice)",
	},
	{
		input: "C50102C20102",
		ptr:   new(tailUint),
	...
	{input: "C50183040404", ptr: new(interface{}), value: []interface{}{[]byte{1}, []byte{4, 4, 4}}},
	{
		input: "C3010203",
		ptr:   new([]io.Reader),
		error: "rlp: types io.Reader is not RLP-serializable",
	},
...
func ExampleDecode_structTagNil() {
	...
	// This types uses the normal rules.
	...
	// This types uses the struct tag.

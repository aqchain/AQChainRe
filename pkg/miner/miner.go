...
// 跟踪downloader事件 当下载开始时StartEvent 停止Mining
// 当下载完成或失败时DoneEvent FailedEvent 判断是否需要启动Mining
...
func (self *Miner) Pending() (*types.Block, *state.StateDB,*state.StateDBRecord) {

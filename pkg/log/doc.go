...
any types that you like. The default output format is logfmt, but you may also choose to use
...
If you really do favor your types-safety, you may choose to pass a log.Ctx instead:
...
This package provides a simple types to annotate a logging operation that you want to be evaluated
lazily, just when it is about to be logged, so that it would not be evaluated if an upstream Handler
filters it out. Just wrap any function which takes no arguments with the log.Lazy types. For example:
...
Becasuse log15 allows you to step around the types system, there are a few ways you can specify
